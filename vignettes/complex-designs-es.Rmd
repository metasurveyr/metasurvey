...
Muchas encuestas nacionales utilizan muestreo estratificado multietapico.
...
design_strat <- svydesign(id = ~1, strata = ~stype, weights = ~pw,
                          data = dt_strat)
...
Para ejemplos reales de disenos estratificados por conglomerados con datos
de CASEN, PNADc, ENIGH y DHS, ver `vignette("international-surveys")`.
