...
Una vez publicada, cualquier persona puede buscar una receta y aplicarla:

```{r aplicar-receta, eval = FALSE}
...
- **[Recetas](recipes.html)** -- Registro de recetas, certificación y descubrimiento
- **[Workflows de Estimación](workflows-and-estimation.html)** -- `workflow()`, `RecipeWorkflow` y estimaciones publicables
- **[Diseños y Validación](complex-designs.html)** -- Estratificación, conglomerados, ponderadores replicados, validación
- **[Paneles Rotativos y PoolSurvey](panel-analysis.html)** -- Análisis longitudinal con `RotativePanelSurvey` y `PoolSurvey`
- **[Estudio de Caso ECH](ech-case-study.html)** -- Análisis laboral completo con comparación STATA
