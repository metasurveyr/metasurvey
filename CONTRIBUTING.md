...
Open an issue describing the use case and expected API. If the feature relates
to a specific survey (ECH, EPH, EAII), include the relevant variable names and
edition.
