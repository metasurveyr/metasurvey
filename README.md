...
metasurvey is **not** a wrapper around `survey`. It adds a reproducibility
layer (steps, recipes, workflows) that is survey-agnostic: the same pipeline
processes ECH, EPH, CASEN, PNAD-C, CPS, ENIGH, or DHS data without
...
Please see [CONTRIBUTING.md](https://github.com/metasurveyr/metasurvey/blob/main/CONTRIBUTING.md) for guidelines on how to
